class Kitten {
  ...
  initializeStatus = () => {
    ...
    if (!this.food.foodtype.length) {
      ...
      else if (age < 42) this.food.foodtype.push(["milk / kitten food", age]);
    ...
    if (!this.milestones.teeth.length) {
      ...
      else this.milestones.teeth.push(["all milk teeth", age]);
    }
    ...
    if (!this.milestones.socialization.length) {
      ...
      else this.milestones.socialization.push(["acclimation period", age]);
    }
  };
    ...
    while (age <= 42) {
      ...
      switch (age) {
        ...
        case 14:
          ...
          break;
        case 21:
          this.milestones.socialization.push(["acclimation period", age]);
...
const getGrowth = (newKitten) => {
  let kitkat = new Kitten(newKitten.birthdate, newKitten.name, newKitten.sex);
